...
export const SystemSettingsAppView: React.FC = () => {
  ...
  // Guard 1: Password Screen (renders at every breakpoint)
  if (!isAuthenticated) {
    return (
  ...
  // Guard 2: Mobile Admin Branch (renders below tablet breakpoint)
  if (!isDesktop) {
    return (
      <MobileSystemSettingsAppView
        windowsList={windowsList}
        setWindowsList={setWindowsList}
        dockOrder={dockOrder}
        setDockOrder={setDockOrder}
        desktopOrder={desktopOrder}
        setDesktopOrder={setDesktopOrder}
        site={site}
        setSite={setSite}
        ...
        handleAddNewChoice={handleAddNewChoice}
        ...
        handleReorderInGroup={handleReorderInGroup}
      />
    );
  }
